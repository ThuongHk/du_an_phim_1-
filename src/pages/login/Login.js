  ...
  <form onSubmit={loginForm.handleSubmit}  className="space-y-12 ng-untouched ng-pristine ng-valid" >
    <div className="space-y-4">
      <div>
        ...
        <input type="text" value={loginForm.values.taiKhoan} onChange={loginForm.handleChange} id="taiKhoan" name="taiKhoan" placeholder="Nhập vào tài khoản của bạn" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" />
      </div>
      <div>
        ...
        <input type="password" value={loginForm.values.password} onChange={loginForm.handleChange} id='password' name="password"  placeholder="*****" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" />
      </div>
    </div>
