        ...
        <div className='row'>
            ...
            <div className="col-4">
                ...
                <div onClick={()=>{ 
                    ...
                    dispatch(callApiDatVe(thongTinDatVe))}} className="cursor-pointer h5 align-items-center justify-content-center text-light  bg-success text-center py-3 ">
                    ĐẶT VÉ
                </div>
...
const PhongVe = () => {
 ...
 return <div className="container"><Tabs defaultActiveKey={toggleTab} items={items} onChange={onChange} /> </div>;
}
